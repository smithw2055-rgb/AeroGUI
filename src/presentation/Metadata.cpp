...
Base::Result<void> Detail::PopulatePresentationMetadata(
    ...
    auto application = Describe<App::Application>(context);
    application
        .Property(
            "StartupUri",
            &App::Application::StartupUri,
            &App::Application::SetStartupUri)
        .Property<
            Base::Ref<ResourceDictionary>,
            &App::Application::SetResources>(
                "Resources",
    ...
    status = Describe<BindingSpec>(context)
        .Factory()
        .Result();
    if (!status) return status.GetStatus();
    ...
    triggerBase
        .Collection<Animation::TriggerAction>(
            "EnterActions",
    ...
    frameworkElement
        ...
        .Collection<Animation::EventTrigger>(
            "Triggers",
