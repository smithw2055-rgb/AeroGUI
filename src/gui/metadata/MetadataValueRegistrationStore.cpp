...
Base::Result<void> MetadataValueRegistrationStore::TryRegisterValueSemantics(
    TypeId type,
...
Base::Result<void> MetadataValueRegistrationStore::TryRegisterTextConverter(
...
Base::Result<void> MetadataValueRegistrationStore::Freeze() noexcept {
    if (frozen_) return {};
...
MetadataValueRegistrationStore::FindValueSemantics(TypeId type) const noexcept {
...
MetadataValueRegistrationStore::FindTextConverter(TypeId type) const noexcept {
