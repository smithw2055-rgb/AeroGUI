...
// extensions / ObjectWriter / facets / template compiler contracts, plus
// WriterSupport helpers used across Writer .cpp files.
...
namespace Aero::Markup {
using ::Aero::Markup::XamlFacets;
using ::Aero::Markup::XamlMarkupExtensionFacet;
using ::Aero::Markup::XamlTypeFacet;
using ::Aero::Markup::XamlLifecycleFacet;
using ::Aero::Markup::XamlNameScopeFacet;
using ::Aero::Markup::XamlResourceScopeFacet;
using ::Aero::Markup::XamlDeferredContentFacet;
using ::Aero::Markup::XamlImplicitResourceKeyFacet;
using ::Aero::Markup::XamlPropertyTargetFacet;
}
...
// Writer .cpp TUs should `using namespace WriterSupport;` (or qualify).
// Schema/facet consumers of this header must not get those names injected
// into Aero::Markup — avoids HasTypeFlag / message-constant collisions.
