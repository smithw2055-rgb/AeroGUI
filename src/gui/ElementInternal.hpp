...
using ElementPrivate = Media::Visual::Impl;
...
public:
    ...
    Base::Result<void> DetachVisual(
        Aero::GuiPrivate::Detail::ElementAttachment& state) noexcept;
    Base::Result<void> AttachVisual(
        Aero::GuiPrivate::Detail::ElementAttachment& state, ::Aero::Media::Visual& newVisualParent) noexcept;
    ...
    Base::Result<Aero::GuiPrivate::Detail::VisualAttachment> ReparentVisual(
        Aero::GuiPrivate::Detail::VisualAttachment& current, ::Aero::Media::Visual& newVisualParent) noexcept;
...
Media::Visual::Impl::Host(const ::Aero::Media::Visual& visual) noexcept {
    return visual.tree_ != nullptr ? visual.tree_->Host() : nullptr;
}

inline void* Media::Visual::Impl::RenderRuntime(
    const ::Aero::Media::Visual& visual) noexcept {
