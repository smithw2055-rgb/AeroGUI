...
#define AERO_REGISTER_ENUM(Type, Name, Values) \
    ...
    AERO_REGISTER_ENUM(
        ...
        description
            .Value("Equal", ::Aero::Media::Animation::ComparisonCondition::Operator::Equal)
            .Value("NotEqual", ::Aero::Media::Animation::ComparisonCondition::Operator::NotEqual)
            .Value("LessThan", ::Aero::Media::Animation::ComparisonCondition::Operator::LessThan)
            .Value("LessThanOrEqual", ::Aero::Media::Animation::ComparisonCondition::Operator::LessThanOrEqual)
            .Value("GreaterThan", ::Aero::Media::Animation::ComparisonCondition::Operator::GreaterThan)
            .Value("GreaterThanOrEqual", ::Aero::Media::Animation::ComparisonCondition::Operator::GreaterThanOrEqual););
    AERO_REGISTER_ENUM(
        ::Aero::Media::Animation::ConditionalExpression::ForwardChaining,
        "ForwardChaining",
        description
            .Value("And", ::Aero::Media::Animation::ConditionalExpression::ForwardChaining::And)
            .Value("Or", ::Aero::Media::Animation::ConditionalExpression::ForwardChaining::Or););
