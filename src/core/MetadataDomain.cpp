...
RoutedEventRegistry& MetadataDomain::RoutedEvents() noexcept {
    AERO_ASSERT(storage_ != nullptr);
    return storage_->routedEvents;
}

const RoutedEventRegistry& MetadataDomain::RoutedEvents() const noexcept {
    AERO_ASSERT(storage_ != nullptr);
    return storage_->routedEvents;
}

MetadataDescriptorStore& MetadataDomain::Descriptors() noexcept {
    AERO_ASSERT(storage_ != nullptr);
...
MetadataFacetStore& MetadataDomain::Facets() noexcept {
    AERO_ASSERT(storage_ != nullptr);
