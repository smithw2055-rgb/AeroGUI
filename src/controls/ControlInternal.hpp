...
public:
    ...
    static std::uint32_t Count(const Panel& panel) noexcept {
        return ::Aero::Media::Visual::Impl::PanelChildCount(panel);
    }
    static Base::Ref<Base::Object> At(
        const Panel& panel,
        std::uint32_t index) noexcept {
        return ::Aero::Media::Visual::Impl::PanelChildAt(panel, index);
    }
    static Base::Result<void> Add(
        Panel& panel,
        const Base::Ref<Base::Object>& owner,
        UIElement& child) noexcept {
        return ::Aero::Media::Visual::Impl::PanelAddChild(panel, owner, child);
    }
    static Base::Result<bool> Remove(
        Panel& panel,
        UIElement& child) noexcept {
        return ::Aero::Media::Visual::Impl::PanelRemoveChild(panel, child);
    }
    static Base::Result<void> Clear(Panel& panel) noexcept {
        ::Aero::Media::Visual::Impl::PanelClearChildren(panel);
        return {};
    }

    static const Base::Ref<Base::Object>& OwnedChild(
        const Decorator& decorator) noexcept {
        return ::Aero::Media::Visual::Impl::DecoratorOwnedChild(decorator);
    }
    static Base::Result<void> SetOwnedChild(
        Decorator& decorator,
        const Base::Ref<Base::Object>& owner,
        UIElement& child) noexcept {
        return ::Aero::Media::Visual::Impl::DecoratorSetOwnedChild(
    ...
    static Base::Result<ItemContainerGenerator*> Create(
        ...
        static void InvalidateGeometry(
            ...
            ::Aero::Media::Visual::Impl::PathInvalidateGeometry(path);
        }
        ...
        static void Attach(
            ...
            ::Aero::Media::Visual::Impl::PathAttachMeshResources(
        ...
        static void Attach(
            ...
            bool invalidate = false) noexcept {
            if (::Aero::Media::Visual::Impl::TextLayoutRuntime(text) == service &&
                !invalidate) {
                return;
            }
