...
$pid = [DesktopLauncher]::Launch("C:\Projects\AeroGUI-R\build\samples\Inventory\Release\AeroInventory.exe", "WinSta0\Default", "C:\Projects\AeroGUI-R")
Write-Output "Launched PID: $pid"
