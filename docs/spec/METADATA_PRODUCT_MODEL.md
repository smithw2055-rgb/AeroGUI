...
Built-in metadata is registered in dependency order: Core, Presentation,
...
Presentation and Controls retain one translation unit each so their private
...
- `Aero::Gui`: retained WPF/XAML controls, presentation and markup.
...
- Application metadata does not reside in Presentation or Controls.
