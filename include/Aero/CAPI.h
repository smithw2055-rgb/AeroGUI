...
enum {
    ...
    AERO_STATUS_ALREADY_EXISTS = 8u,
    AERO_STATUS_INVALID_STATE = 9u,
    AERO_STATUS_NOT_FOUND = 10u,
    AERO_STATUS_ID_COLLISION = 11u,
    AERO_STATUS_CYCLE_DETECTED = 12u,
    AERO_STATUS_WRONG_THREAD = 13u,
    AERO_STATUS_READ_ONLY = 14u,
